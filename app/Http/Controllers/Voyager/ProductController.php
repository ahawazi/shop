...
class ProductController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        // check if category marked before
        $product = Product::find($id);
        $categoryForProducts = $product->categories()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','categories','categoryForProducts'));
    }
